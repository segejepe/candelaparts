...
const opticsParts = [
  ...
  new GmpOpticsparts('7122-00-9432', 'AIMING BEAM, ASSY, SPECTRUM', '', '', ''),
  ...
  new GmpOpticsparts('7122-00-9458', 'BEAM SPLITTER, ASSY', '', '', ''),
  new GmpOpticsparts('8055-00-0309', 'SPECTRUM HEAD DETECTOR BEAMSPLITTER', 'BEAM SPLITTER Lens only', '', ''),
  new GmpOpticsparts('7122-00-9575', 'DHP FIBER RECEPTACLE', '', '', ''),
  new GmpOpticsparts('8050-00-9003', 'Fiber foucs lens', 'Fiber foucs lens only', '', ''),
  new GmpOpticsparts('7122-00-9457', 'ASSY,HEAD DETECTOR, GMAX PRO', '', '', ''),
...
const consumableParts = [
  ...
  new GmpConsumableparts('7122-00-9561', '3MM SLIDER ATTACHMENT ASSY', '', '', 'F15.1'),
  new GmpConsumableparts('7122-00-9753', 'Assy, 5mm Spot Slider Attachment', '5mm', '', ''),
  new GmpConsumableparts('7122-00-9747', 'LARGE SPOT SLIDER ATTACHMENT ASSY', '20/22/24', '', ''),
  new GmpConsumableparts('1301-00-9430', 'WINDOW, SPECTRUM CALPORT', 'Calport window', '', ''),
  new GmpConsumableparts('8901-00-9442', 'Preventative Maintenance Kit, Pro', 'PM kit', '', ''),
  new GmpConsumableparts('7122-00-9435', 'SWING ARM,FIBER POLE,ASSY', '', '', 'Only Fiber pole'),
  new GmpConsumableparts('7122-00-9436', 'GUIDE TUBE,FIBER POLE,ASSY,SPECTRUM', '', '', ''),
  new GmpConsumableparts('1301-00-9409', 'DCD COVER, SPECTRUM', '', '', ''),
  new GmpConsumableparts('7122-00-9537', 'FIBER POLE ACCES KIT,ASSY,GL P', '', '', ''),
  new GmpConsumableparts('1301-00-9870', 'PRO SERIES CALPORT SW STRP', 'Inside calport', '', ''),
  new GmpConsumableparts('1301-00-9537', 'HOLDER,HAND PIECE,MOLDED, FRONT', '', '', ''),
  new GmpConsumableparts('1301-00-9536', 'HOLDER,HAND PIECE,MOLDED, REAR', '', '', ''),
  new GmpConsumableparts('1301-00-9535', 'Upper holder', '', '', ''),
  ...
  new GmpConsumableparts('3430-02-0010', 'CRYOGEN RELEASE VALVE', '', '', ''),
  new GmpConsumableparts('7122-00-9655', 'Sapphire Window Kit Assy', '', '', ''),
  new GmpConsumableparts('7122-00-9656', 'ASSY, WINDOW HOLDER, ULTEM', '', '', ''),
  new GmpConsumableparts('7122-00-9657', 'ASSY, KIT, WINDOW HOLDER, ULTEM 5 PC', '', '', ''),
  new GmpConsumableparts('7122-00-9436', 'GUIDE TUBE,FIBER POLE,ASSY,SPECTRUM', '', '', ''),
  new GmpConsumableparts('5501-00-1014', 'PRO HP 8 HEMOSTAT, NONLOCKING', 'Forcep', '', ''),
  new GmpConsumableparts('2157-40-8148', 'GMAX LASER RADIATION WALL SIGN', '', '', ''),
  new GmpConsumableparts('2157-40-5000', 'LASER RADIATION SYMBOL WALL SIGN', '', '', ''),
  ...
  new GmpConsumableparts('1600-00-0219', 'DCD Cryogen/15 Pack', '', '', ''),
  new GmpConsumableparts('5103-00-0030', 'FOOTSWITCH', '', '', ''),
  new GmpConsumableparts('3450-00-0349', 'SIDE FILTER,GENTLELASE PRO', '', '', ''),
  new GmpConsumableparts('7122-00-9435', 'SWING ARM FIBER POLE PRO SERIES', '', '', ''),
  ...
  new GmpConsumableparts('7122-00-3363', 'ASSY,TOOL,ALIGN,CROSSHAIR,MGL', '', '', ''),
  new GmpConsumableparts('7122-00-3362', 'ASSY,ALIGN VER TOOL,MGL', '', '', ''),
  new GmpConsumableparts('1303-00-0114', 'GAUGE, DISTANCE, 20MM LARGE SPOT', '', '', ''),
  new GmpConsumableparts('7122-00-9758', 'Large Spot Distance Gauge Kit', '', '', ''),
  new GmpConsumableparts('7122-00-9521', 'GL PRO 12mm DIST GAUGE KIT, ASSY', 'PRO Series 12mm Distance Gauge -5Pk', '', ''),
  new GmpConsumableparts('7122-00-9418', '15MM DISTANCE GAUGE KIT', 'PRO Series 15mm Distance Gauge -5Pk', '', ''),
  new GmpConsumableparts('7122-00-9424', '18MM DISTANCE GAUGE KIT', 'PRO Series 18mm Distance Gauge -5Pk', '', ''),
  new GmpConsumableparts('1630-00-0431', 'THERMOCHROMIC INK PAPER', '', '', ''),
  new GmpConsumableparts('1301-00-9378', 'FRONT HANDLE SPECTRUM LASER', '', '', ''),
  new GmpConsumableparts('7122-00-9574', 'DHP FIBER RECEPTACLE ASSY', '', '', ''),
  new GmpConsumableparts('7122-00-9448', 'TOP PANEL ASSY, GL PRO, ASSY', '', '', ''),
  new GmpConsumableparts('7122-00-9429', 'RIGHT PANEL ASSY, SPECTRUM', '', '', ''),
  new GmpConsumableparts('7122-00-9430', 'LEFT PANEL ASSY, SPECTRUM', '', '', ''),
  new GmpConsumableparts('7122-00-9449', 'FRONT PANEL, ASSY, GL PRO, ASSY', '', '', ''),
  ...
  new GmpConsumableparts('2846-30-0808', 'SCR,SEMS,EXT TH,PHLPS,8-32x1/2', '', '', ''),
  new GmpConsumableparts('2846-30-0806', 'SCR,SEMS,EXT,PAN,PHLPS,8-32x3/8,SS', '', '', ''),
  new GmpConsumableparts('2846-31-1006', 'SCR,SEMS,EXTH,PHILPS,10-32X3/8', '', '', ''),
  new GmpConsumableparts('2846-30-0806', 'SCR,SEMS,EXT,PAN,PHLPS,8-32x3/8,SS', '', '', ''),
  ...
  new GmpConsumableparts('8095-00-0476', 'PF1 EYEWEAR 755/1064 OD7 CE', 'Operator goggles', '', ''),
  new GmpConsumableparts('8095-00-0470', 'GOGGLES, PATIENT, LASER, SS, CE', '', '', ''),
  new GmpConsumableparts('7122-00-3329', 'Assy,Axial Fan,80MM SQ,28.2CFM', '', '', ''),
  new GmpConsumableparts('1301-00-9401', 'LEFT SHELL DCD H/P SPECTRUM', '', '', ''),
  new GmpConsumableparts('1301-00-9405', 'RIGHT SHELL DCD H/P SPECTRUM', '', '', ''),
  new GmpConsumableparts('1301-00-9403', 'TRIGGER BUTTON H/P SPECTRUM', '', '', ''),
  new GmpConsumableparts('1303-00-0220', 'FINGER SWITCH, H/P, PRO,ROHS', '', '', '')
];
...
const electronicsParts = [
  ...
  new GmpElectronicsparts('7122-00-9596', 'ASSY SIGNAL HARNESS GMAX PRO', '4 Digits SN Part', '', ''),
  new GmpElectronicsparts('7123-07-0014', 'Split IO', '', '', ''),
  new GmpElectronicsparts('7123-00-0588', 'ASSY, Q7 LCD DISPLAY', 'New Display for 5digts', '', ''),
  new GmpElectronicsparts('7111-07-2793', 'AC DIST ROHS PCB ASSY SPECTRUM', '', '', ''),
  new GmpElectronicsparts('7122-00-3330', 'Assy,Linecord,MGL', '', '', ''),
  new GmpElectronicsparts('7122-00-9235', 'ASSY DCD MODULE SPECTRUM', '', '', ''),
  new GmpElectronicsparts('7111-07-2520', 'Assy,BOM,RoHS PCB,DCD Canister', '', '', ''),
  new GmpElectronicsparts('3409-02-0200', 'FERRULE,SET,1/8T,NYLON', '', '', ''),
  new GmpElectronicsparts('1301-00-8462', 'CLIP SPR DCD', '', '', ''),
  ...
  new GmpElectronicsparts('7122-00-9596', 'ASSY SIGNAL HARNESS GMAX PRO', '', '', ''),
  ...
  new GmpElectronicsparts('7122-00-9441', 'DISPLAY BEZEL ASSY,GENTLE LASE PRO', '', '', ''),
  new GmpElectronicsparts('7122-00-9460', 'DISPLAY BEZEL,REAR ASSY, GL PRO', '', '', ''),
  new GmpElectronicsparts('7111-07-2807', 'ASSY, ROHS, HV DUMP ASSY, GMAX PRO', '', '', ''),
  new GmpElectronicsparts('1510-00-7225', 'CAP 9000UF,1.4KV,1125/7875 RND', '', '', ''),
  new GmpElectronicsparts('7122-00-3803', 'ASSY,THYR,VBEAM2', 'F5.2', '', '')
];
...
const fluidSystem = [
  ...
  new GmpFluidsystem('1301-00-9390', 'TUBING, RESEVOIR TO PUMP', '', '', ''),
  new GmpFluidsystem('7122-00-9592', 'ASSY, FLOW SWITCH 0.50 GPM, FS Cooling system with Heater', '', '', ''),
  new GmpFluidsystem('4508-00-4023', 'CONTRACTOR DP 40A 230VAC COIL', '', '', ''),
  new GmpFluidsystem('7111-07-2799', 'PCB ASSY ROHS HV SPLIT CAP SPECTRUM', '', '', ''),
  new GmpFluidsystem('3450-00-0355', 'PRO SERIES DI CARTRIDGE/ FILTER', '', '', ''),
  new GmpFluidsystem('7122-00-9238', 'ASSY RESERVOIR SPECTRUM', '', '', ''),
  ...
  new GmpFluidsystem('3414-00-0246', 'PUMP, 6.2 GPM 24VDC 3.2A CRD WITH NEW CASE ORIENTATION', '', '', ''),
  new GmpFluidsystem('7122-00-9592', 'ASSY, FLOW SW, 0.5GPM, COMP FITTINGS', '', '', ''),
  new GmpFluidsystem('4050-05-0002', 'PLUG,2 POS,5.08MM,SCREW TERM', '', '', ''),
  new GmpFluidsystem('4050-05-0003', 'Jumper,2 POS,5.08mm', '', '', ''),
  ...
  new GmpFluidsystem('8120-00-0001', 'PRO FLUID MODULE, NO HEATER', '', '', ''),
  new GmpFluidsystem('5108-06-0175', 'THERMO,NC,OPEN@175F,CLOSE@145F', 'F7.2', '', '')
];
...
const headParts = [
  ...
  new GmpHeadparts('7122-00-9578', 'DHP YAG HEAD ASSY', '', '', ''),
  new GmpHeadparts('1301-00-9584', 'HEAD MANIFOLD,YAG,DHP', 'Yag Head', '', ''),
  new GmpHeadparts('1301-00-9444', 'HEAD MANIFOLD, SPECTRUM', 'Yag Head', '', ''),
  new GmpHeadparts('1301-00-9583', 'HEAD MANIFOLD,ALEX,DHP', 'For Alex Head: 2ea', '', ''),
  new GmpHeadparts('3406-41-0804', 'ELBOW,MALE, 45 DEGREE, 1/2x1/4 NPT,SS', 'Yag Head', '', ''),
  new GmpHeadparts('3406-10-0804', 'CONN,MALE 1/2T x1/4MPT SS', 'Yag Head', '', ''),
  ...
  new GmpHeadparts('7122-00-9207', 'Pump Cavity', '', '', ''),
  new GmpHeadparts('1301-00-7763', 'Yag ROD', '', '', ''),
  new GmpHeadparts('1301-00-7014', 'Alex ROD', '', '', ''),
];
...
const gmphd = [
  ...
  new GmpHandpieceparts('7122-00-9404', 'PRO SERIES ACC HP W/O AIR CLIP', 'ACC Handpiece', '', ''),
  new GmpHandpieceparts('7122-00-9752', 'ACC LARGE SPOT DELIVERY SYSTEM ASSY', 'ACC Handpiece(Large Spot)', '', ''),
  new GmpHandpieceparts('7122-00-9420', 'PRO SERIES AIR CLIP', 'ACC Handpiece AIR CLIP', '', ''),
  new GmpHandpieceparts('7122-00-9527', 'VELCRO STRAP KIT', '', '', ''),
  new GmpHandpieceparts('7122-00-9585', 'PRO SERIES ACC HP W AIR CLIP W/O FIBER', '', '', ''),
  new GmpHandpieceparts('7122-00-9752', 'ACC LARGE SPOT DELIVERY SYSTEM ASSY', '', '', ''),
  new GmpHandpieceparts('7122-00-9419', 'PRO SERIES FIBER', '', '', ''),
  new GmpHandpieceparts('3160-00-1150', 'O-RING, 13/16ID, 3/32W, BUNA-N', 'Inside of Handpiece', '', ''),
